  ...
  return [
    {
      name: "dashboard",
      list: "/",
      meta: { label: t("resources.dashboard"), icon: <DashboardOutlined /> },
    },
    // 报价系统
    {
      name: "quote",
      list: "/quote",
      meta: { label: t("resources.quote"), icon: <SearchOutlined /> },
    },
    {
      // 维修核心业务
      name: "repair_orders",
    ...
    },
    {
      ...
      create: "/sales/create",
      show: "/sales/show/:id",
      meta: { label: t("resources.salesOrders"), icon: <ShoppingOutlined /> },
    },
    {
      // 客户管理
      name: "customers",
    ...
    },
    {
      ...
      meta: {
        label: t("resources.transactions"),
        icon: <DollarOutlined />,
      },
    },
    // 系统设置
